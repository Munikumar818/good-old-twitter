    ...
    return(
        ...
        <SidebarOptions active Icon={ HomeIcon} text='Home'/>
            ...
            <div className="Profile_info">
                ...
                <IconButton size="small" sx={{ml:2}} aria-controls={openMenu?"basic-menu":undefined}  aria-haspopup='true' aria-expanded={openMenu?"true":undefined} onClick={handleClick}><MoreHorizIcon/></IconButton>
                <Menu id="basic-menu" anchorEl={anchorEl} open={openMenu} onClick={handlClose} onClose={handlClose}>
                    ...
                    <Divider/>
                    <MenuItem onClick={handlClose}>Add an existing account</MenuItem>
